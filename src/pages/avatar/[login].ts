...
function fallbackAvatar(login: string, status = 200): Response {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 160"><rect width="160" height="160" rx="32" fill="#0b0d12"/><text x="80" y="103" text-anchor="middle" font-family="monospace" font-size="72" fill="#9784ff">${initial}</text></svg>`;
